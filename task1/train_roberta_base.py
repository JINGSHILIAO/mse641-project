...
# Model
# Dropout is default to 0.1 when not defined
...
for epoch in range(1, epochs + 1):
    ...
    if val_f1 > best_val_f1:
        best_val_f1 = val_f1
        torch.save(model.state_dict(), "task1/outputs/best_roberta_base_model.pt")
        early_stop_counter = 0
    else:
...
df.to_csv("task1/outputs/train_roberta_base_log.csv", index=False)
